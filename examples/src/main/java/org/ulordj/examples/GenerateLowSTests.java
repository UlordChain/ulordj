...
import org.ulordj.crypto.TransactionSignature;
...
import static org.ulordj.script.ScriptOpCodes.getOpCodeName;
import org.ulordj.signers.LocalTransactionSigner;
import org.ulordj.signers.TransactionSigner.ProposedTransaction;
import org.ulordj.wallet.KeyBag;
import org.ulordj.wallet.RedeemData;
...
public class GenerateLowSTests {
    ...
    public static void main(final String[] argv) throws NoSuchAlgorithmException, IOException {
        final NetworkParameters params = new TestNet3Params();
