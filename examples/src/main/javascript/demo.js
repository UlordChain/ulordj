...
// This file shows how to use ulordj from Javascript.
// To run, grab the ulordj bundled JAR and then do something like this:
//
//   jjs -cp ulordj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp ulordj-0.12-bundled.jar
//
...
//
//   jjs -cp ulordj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And ulordj is a threaded library. This means you
