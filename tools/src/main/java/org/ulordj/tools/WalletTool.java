...
package org.ulordj.tools;

import org.ulordj.crypto.*;
import org.ulordj.params.MainNetParams;
import org.ulordj.params.RegTestParams;
...
import org.ulordj.script.ScriptBuilder;
...
import org.ulordj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.ulordj.core.PeerAddress;
...
import org.ulordj.core.listeners.BlocksDownloadedEventListener;
import org.ulordj.core.listeners.DownloadProgressTracker;
import org.ulordj.wallet.MarriedKeyChain;
import org.ulordj.wallet.Protos;
import org.ulordj.wallet.SendRequest;
import org.ulordj.wallet.Wallet;
import org.ulordj.wallet.WalletExtension;
import org.ulordj.wallet.WalletProtobufSerializer;
import org.ulordj.wallet.Wallet.BalanceType;
...
import static org.ulordj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.ulord.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("ulord")) {
            try {
            ...
            try {
                paymentRequest = org.ulord.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
