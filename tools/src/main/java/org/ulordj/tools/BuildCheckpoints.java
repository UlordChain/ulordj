...
import org.ulordj.core.listeners.NewBestBlockListener;
...
public class BuildCheckpoints {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Configure ulordj to fetch only headers, not save them to disk, connect to a local fully synced/validated
        ...
        System.out.println("checkpoints" + suffix);
