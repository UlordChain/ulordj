...
package org.ulordj.protocols.channels;

import org.ulordj.core.*;
import org.ulordj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.ulordj.script.ScriptPattern;
import org.ulordj.testing.TestWithWallet;
import org.ulordj.utils.Threading;
import org.ulordj.wallet.Wallet;
import org.ulordj.wallet.WalletExtension;
import org.ulordj.wallet.WalletFiles;
...
import org.ulord.paymentchannel.Protos;
...
import static org.ulordj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.ulordj.testing.FakeTxBuilder.createFakeBlock;
import static org.ulord.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.ulordj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
