...
import org.ulordj.core.listeners.PeerDisconnectedEventListener;
import org.ulordj.core.listeners.PreMessageReceivedEventListener;
...
public class TestWithNetworkConnections {
    ...
    private void outboundPingAndWait(final InboundMessageQueuer p, BigInteger nonce) throws Exception {
    ...
    private void inboundPongAndWait(final InboundMessageQueuer p, final BigInteger nonce) throws Exception {
    ...
    protected void pingAndWait(final InboundMessageQueuer p) throws Exception {
        final BigInteger nonce = BigInteger.valueOf((long) (Math.random() * Long.MAX_VALUE));
