...
import org.ulordj.core.Transaction.Purpose;
...
import org.ulordj.crypto.DeterministicKey;
import org.ulordj.params.MainNetParams;
import org.ulordj.params.UnitTestParams;
import org.ulordj.script.ScriptBuilder;
import org.ulordj.testing.FakeTxBuilder;
import org.ulordj.testing.FooWalletExtension;
import org.ulordj.utils.BriefLogFormatter;
import org.ulordj.utils.Threading;
import org.ulordj.wallet.DeterministicKeyChain;
import org.ulordj.wallet.KeyChain;
...
import org.ulordj.wallet.UnreadableWalletException;
...
public class WalletProtobufSerializerTest {
    ...
    public void coinbaseTxns() throws Exception {
        ...
        Block b = UNITTEST.getGenesisBlock().createNextBlockWithCoinbase(Block.BLOCK_VERSION_GENESIS, myKey.getPubKey(), ONE_COIN, Block.BLOCK_HEIGHT_GENESIS);
