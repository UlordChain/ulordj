...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        assertEquals(ONE_COIN, wallet.getBalance());
    ...
    public void testForking4() throws Exception {
        ...
        assertEquals(ONE_COIN, wallet.getBalance());
        Address dest = LegacyAddress.fromKey(UNITTEST, new ECKey());
        Transaction spend = wallet.createSend(dest, ONE_COIN);
    ...
    public void coinbaseDeath() throws Exception {
        ...
        // ... and spend.
        Transaction fodder = wallet.createSend(LegacyAddress.fromKey(UNITTEST, new ECKey()), ONE_COIN);
