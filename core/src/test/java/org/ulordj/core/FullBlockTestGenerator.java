...
import org.ulordj.core.Transaction.SigHash;
...
import static org.ulordj.script.ScriptOpCodes.*;
...
public class FullBlockTestGenerator {
    // Used by UlorddComparisonTool and AbstractFullPrunedBlockChainTest to create test cases
    ...
    public RuleList getBlocksToTest(boolean runBarelyExpensiveTests, boolean runExpensiveTests, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        spendableOutputs.offer(new TransactionOutPointWithValue(
                ...
                ONE_COIN, chainHead.getTransactions().get(0).getOutputs().get(0).getScriptPubKey()));
        ...
        NewBlock b47 = createNextBlock(b44, chainHeadHeight + 16, out15, null);
        {
            try {
                ...
                while (true) {
                    ...
                    b47.block.setNonce(b47.block.getNonce().add(BigInteger.ONE));
                }
    ...
    private NewBlock createNextBlock(Block baseBlock, int nextBlockHeight, @Nullable TransactionOutPointWithValue prevOut,
        ...
        Coin coinbaseValue = ONE_COIN.shiftRight(nextBlockHeight / params.getSubsidyDecreaseBlockCount())
