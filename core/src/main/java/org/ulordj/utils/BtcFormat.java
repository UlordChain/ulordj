...
package org.ulordj.utils;

import org.ulordj.utils.BtcAutoFormat.Style;
import static org.ulordj.utils.BtcAutoFormat.Style.*;
 ...
 * {@code "฿"}.</p>
 *
 * <p>The denomination used when formatting will be either ulord, millicoin
 ...
 * locale, a value of one ulord might be formatted as {@code ฿1.00} where a value
 ...
 * {@code 1.0000 BTC}, or one ulord, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-ulord value:</p>
 *
 * <blockquote><pre>
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a ulord monetary value and returns an {@link AttributedCharacterIterator}.
    ...
    /**
     * Formats a ulord value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a ulord value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a ulord monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a ulord quantity of any type the
