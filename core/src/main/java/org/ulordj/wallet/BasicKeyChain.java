...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.ulordj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.ulordj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all ulord controlled by that private key is lost forever).
