...
import org.ulordj.core.listeners.*;
import org.ulordj.core.Address;
import org.ulordj.core.AbstractBlockChain;
import org.ulordj.core.BlockChain;
import org.ulordj.core.BloomFilter;
import org.ulordj.core.Coin;
import org.ulordj.core.Context;
import org.ulordj.core.ECKey;
import org.ulordj.core.FilteredBlock;
import org.ulordj.core.InsufficientMoneyException;
import org.ulordj.core.LegacyAddress;
import org.ulordj.core.Message;
import org.ulordj.core.NetworkParameters;
import org.ulordj.core.Peer;
import org.ulordj.core.PeerFilterProvider;
import org.ulordj.core.PeerGroup;
import org.ulordj.core.Sha256Hash;
import org.ulordj.core.StoredBlock;
import org.ulordj.core.Transaction;
import org.ulordj.core.TransactionBag;
import org.ulordj.core.TransactionBroadcast;
import org.ulordj.core.TransactionBroadcaster;
import org.ulordj.core.TransactionConfidence;
import org.ulordj.core.TransactionInput;
import org.ulordj.core.TransactionOutPoint;
import org.ulordj.core.TransactionOutput;
import org.ulordj.core.UTXO;
import org.ulordj.core.UTXOProvider;
import org.ulordj.core.UTXOProviderException;
import org.ulordj.core.Utils;
import org.ulordj.core.VerificationException;
import org.ulordj.core.TransactionConfidence.*;
import org.ulordj.crypto.*;
import org.ulordj.script.*;
import org.ulordj.signers.*;
import org.ulordj.utils.*;
import org.ulordj.wallet.Protos.Wallet.*;
import org.ulordj.wallet.WalletTransaction.*;
import org.ulordj.wallet.listeners.KeyChainEventListener;
import org.ulordj.wallet.listeners.ScriptsChangeEventListener;
import org.ulordj.wallet.listeners.WalletChangeEventListener;
import org.ulordj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.ulordj.wallet.listeners.WalletCoinsSentEventListener;
import org.ulordj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 *
 * <p>To learn more about this class, read <b><a href="https://ulordj.github.io/working-with-the-wallet">
 ...
 * other objects, see the <a href="https://ulordj.github.io/getting-started">Getting started</a> tutorial
...
public class Wallet extends BaseTaggableObject
     ...
     * key, after loading a wallet produced by previous versions of ulordj. If the wallet is encrypted the key
     ...
     * @throws org.ulordj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Returns the amount of ulord ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of ulord ever sent via output. If an output is sent to our own wallet, because of change or
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.ulordj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.ulordj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
