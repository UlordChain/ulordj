...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/ulordj:" + BITCOINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for ulordj
     * users might look like "/ulordj:0.13/MultiBit:1.2/" where libraries come further to the left.</p>
     *
     ...
     * set of "/ulordj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
