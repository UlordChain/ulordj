...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * the FP rate higher, due to <a href="https://groups.google.com/forum/#!msg/ulordj/Ys13qkTwcNg/9qxnhwnkeoIJ">
     * various complexities</a> there are still ways a remote peer can deanonymize the users wallet. This is why the
     * FP rate is chosen for performance rather than privacy. If a future version of ulordj fixes the known
     ...
     * and easy way for a user to upgrade a ulordj based app running in SPV mode to fully validating security.
     */
