...
package org.ulordj.core;

import com.google.common.base.*;
import com.google.common.base.Objects;
import org.ulordj.core.listeners.*;
import org.ulordj.net.AbstractTimeoutHandler;
import org.ulordj.net.NioClient;
import org.ulordj.net.NioClientManager;
import org.ulordj.net.StreamConnection;
import org.ulordj.store.BlockStore;
import org.ulordj.store.BlockStoreException;
import org.ulordj.utils.ListenerRegistration;
...
public class Peer extends PeerSocketHandler {
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // ulordj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    protected void processAlert(AlertMessage m) {
        try {
            ...
            // BigInteger implementations! See https://github.com/ulordj/ulordj/issues/526 for discussion. As
    ...
    protected void processInv(InventoryMessage inv) {
        ...
        if (pingAfterGetData)
            sendMessage(new Ping(BigInteger.valueOf((long) (Math.random() * Long.MAX_VALUE))));
    }
    ...
    private class PendingPing {
        ...
        public PendingPing(BigInteger nonce) {
    ...
    public ListenableFuture<Long> ping() throws ProtocolException {
        return ping(BigInteger.valueOf((long) (Math.random() * Long.MAX_VALUE)));
    }

    protected ListenableFuture<Long> ping(BigInteger nonce) throws ProtocolException {
