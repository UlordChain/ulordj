...
import org.ulord.NativeSecp256k1;
import org.ulord.NativeSecp256k1Util;
import org.ulord.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.ulordj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.ulordj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
