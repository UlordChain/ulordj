...
public abstract class AbstractBlockChain {
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            // article here for more details: https://ulordj.github.io/security-model
            try {
                block.verifyHeader();
...
//                    newTargetCompact + " vs " + receivedTargetCompact);
    ...
    private void checkTestnetDifficulty(StoredBlock storedPrev, Block prev, Block next) throws VerificationException, BlockStoreException {
        ...
        // There is an integer underflow bug in ulord-qt that means mindiff blocks are accepted when time
        // goes backwards.
...
//                        Long.toHexString(next.getDifficultyTarget()));
    ...
    private void UlordGravityWave(StoredBlock storedPrev, Block nextBlock) {
    ...
    private void UlordGravityWave3(StoredBlock storedPrev, Block nextBlock) {
