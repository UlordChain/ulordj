...
public abstract class Message {
    ...
    /**
     * <p>Serialize this message to a byte array that conforms to the ulord wire protocol.</p>
     *
    ...
    /**
     * Serialize this message to the provided OutputStream using the ulord wire format.
     *
     * @param stream
     * @throws IOException
     */
