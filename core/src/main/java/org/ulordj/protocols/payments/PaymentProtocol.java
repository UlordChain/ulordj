...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/ulord-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/ulord-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/ulord-paymentack";
