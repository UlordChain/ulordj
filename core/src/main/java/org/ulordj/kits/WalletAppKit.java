...
import org.ulordj.net.discovery.*;
import org.ulordj.protocols.channels.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV ulordj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit ulordj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing ulordj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the ulordj website
     * (https://ulordj.github.io/speeding-up-chain-sync) for further details.
     */
