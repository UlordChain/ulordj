 ...
 *
 * <ul>
 * <li>{@code ulord:<address>}</li>
 * <li>{@code ulord:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class UlordURI {
    ...
    public UlordURI(@Nullable NetworkParameters params, String input) throws UlordURIParseException {
        ...
        // blockchain.info generates URIs of non-BIP compliant form ulord://address?....
        // We support both until Ben fixes his code.
        
        // Remove the ulord scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : ulord:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
